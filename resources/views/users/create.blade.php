<x-app-layout>
    ...
    <x-slot name="title">
       Creación de Usuarios AMT
    </x-slot>
    <div class="p-28 ">
        <div class="cardheader text-center">
            <h1 class="text-3xl">Crear Usuario</h1>
        </div>
        <div class="cardBody mt-9">
            <form class="max-w-md mx-auto" method="POST" action="{{ route('users.store') }}">
                @csrf
                <div class="w-full h-auto p-12 border-2">
                    ...
                    <div class="flex flex-col mt-2">
                        ...
                        <div class="w-full">
                            <select name="user_type" id="user_type" class="rounded-md h-10 text-xs border-gray-300">
