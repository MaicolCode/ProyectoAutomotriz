<!-- Main modal -->
<div id="authentication-modal-service-edit-{{ $service }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="authentication-modal-service-edit-{{ $service }}">
            ...
            <div class="p-4 md:p-4">
                <form class="space-y-4" action="{{ route('service.update', $service) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    <div>
                        <label for="se_nombre" class="block mb-2 text-sm font-medium text-gray-900 ">Servicio</label>
                        <input type="text" name="se_nombre" id="se_nombre" value="{{ $nombre }}"
                            placeholder="Nombre el servicio a registrar..."
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">

                    </div>
                    <div>
                        <label for="se_descripcion"
                        ...
                        <textarea
                            ...
                            name="se_descripcion" id="se_descripcion" cols="30" rows="10" placeholder="Describa el servicio...">{!! $descripcion !!}</textarea>
                    </div>
                    <div>
                        <label for="se_precio" class="block mb-2 text-sm font-medium text-gray-900 ">Precio</label>
                        <input type="number" name="se_precio" id="se_precio" value="{{ $precio }}" min="0.00"
                            step="0.01"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    ...
                    <div>
                        ...
                        <input type="text" name="se_image" id="se_image" value="{{ $image }}"
                            placeholder="Inserta la URL de la imagen a insertar..."
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                    ...
                    <div class="flex w-full items-center gap-5 p-5">
                        ...
                        <button data-modal-hide="authentication-modal-service-edit-{{ $service }}" type="button"
