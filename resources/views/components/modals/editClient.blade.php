<!-- Main modal -->
<div id="authentication-modal-client-edit-{{ $cliente }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="authentication-modal-client-edit-{{ $cliente }}">
            ...
            <div class="p-4 md:p-4">
                <form class="space-y-4" action="{{ route('cliente.update', $cliente) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    <div class="flex items-center w-auto gap-5">
                        <div>
                            ...
                            <input type="text" name="id" id="id"
                                ...
                                placeholder="Identificacion del cliente..." value="{{ $cliente }}" required />
                        </div>
                        <div>
                            <label for="Nombre"
                                class="block mb-2 text-sm font-medium text-gray-900">Nombres</label>
                            <input type="text" name="Nombre" id="Nombre"
                                ...
                                placeholder="Nombre del cliente..." value="{{ $nombre }}" required />
                        </div>
                    </div>
                    <div>
                        <label for="Correo"
                        ...
                        <input type="email" name="Correo" id="Correo"
                            ...
                            placeholder="cliente@gmail.com" value="{{ $correo }}" required />
                    </div>
                    <div>
                        <label for="Direccion"
                        ...
                        <input type="text" name="Direccion" id="Direccion"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                            placeholder="Dirección del cliente..." value="{{ $direccion }}" required />
                    </div>
                    <div>
                        <label for="Telefono"
                        ...
                        <input type="text" name="Telefono" id="Telefono"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                            placeholder="Telefóno del cliente..." value="{{ $telefono }}" required />
                    </div>
                    <div class="flex w-full items-center gap-5 p-5">
                        ...
                        <button data-modal-hide="authentication-modal-client-edit-{{ $cliente }}" type="button"
