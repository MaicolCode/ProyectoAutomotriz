...
inline-flex items-center px-1 pt-1 hover:border-b-2 hover:border-rgba-blue-sky-200 leading-1 focus:outline-none focus:border-rgba-blue-sky-100 transition duration-200 ease-in-out" />
    ...
    <section class="relative w-full lg:min-h-screen flex flex-col items-center">
        {{-- Seccion del Header --}}
        <div class=" relative shadow-md flex items-center" style="height: 700px">
            <img src="https://www.nicepng.com/png/full/120-1207720_mecanico-de-cuerpo-entero.png"
                alt="mecanico-de-cuerpo-entero_By_NicePng" class="absolute bottom-0  right-0 z-20 mr-10 w-44 lg:w-60">
            <article class="skewed bg-rgba-blue-sky-100">
            </article>
            <div class="px-16 z-10">
                <b class=" text-4xl">Sección de recomendaciones</b>
                <hr>
                <p class="w-3/4 lg:w-3/5 mt-10 text-xl lg:text-lg">Automotriz Tipan a parte de ofrecerte sus servicios,
        ...
        <div class="my-10 relative shadow-md flex flex-col items-center w-full lg:w-3/6 z-10 bg-blue-50 rounded-lg">
            <b class="text-4xl mt-10 text-center">Dentro de esta seccion encontraras: </b>
            <div class="timeList mt-5 px-20 py-10">
                <ol class="relative border-s border-gray-200 dark:border-gray-700">
                    <li class="mb-10 ms-4">
                        ...
                        <h3 class="text-3xl lg:text-lg font-semibold text-rgba-blue-sky-100">Recomendaciones</h3>
                        <p class="text-xl lg:text-sm font-normal text-gray-500 dark:text-gray-400">
                    ...
                    <li class="mb-10 ms-4">
                        ...
                        <h3 class="text-3xl lg:text-lg font-semibold text-rgba-blue-sky-100">Instrucciones</h3>
                        <p class=" text-xl lg:text-sm  font-normal text-gray-500 dark:text-gray-400">
                    ...
                    <li class="mb-10 ms-4">
                        ...
                        <h3 class="text-3xl lg:text-lg font-semibold text-rgba-blue-sky-100">Herramientas </h3>
                        <p class=" text-xl lg:text-sm  font-normal text-gray-500 dark:text-gray-400">
                    ...
                    <li class="ms-4">
                        ...
                        <h3 class="text-3xl lg:text-lg font-semibold text-rgba-blue-sky-100">Precauciones</h3>
                        <p class=" text-xl lg:text-sm  font-normal text-gray-500 dark:text-gray-400">
        ...
        <div class=" relative shadow-md flex flex-col bg-gray-500 w-full p-2" style="height: 750px" id="sectionPosts">
            ...
            <div class="flex justify-center">
                <div id="indicators-carousel" class="relative w-3/5 z-0" data-carousel="static">
                    <!-- Carousel wrapper -->
                    <div class="flex w-full relative overflow-hidden rounded-lg md:h-96" style="height: 500px">
                        <!-- Item 1 -->
                        <div class="flex duration-1000 ease-in-out  justify-center w-full" style="height: 450px"
                            data-carousel-item="active">
                            <div
                                class="relative flex items-center justify-center p-6 bg-white rounded-lg shadow-xl shadow-slate-800 dark:bg-gray-400 dark:border-gray-700 dark:bg-opacity-40" style="width:500px">
                                <h2 class="text-2xl text-white text-center">Aquí verás todo el contenido compartido por la empresa.</h2>

                            </div>
                        </div>

                        @foreach ($posts as $post)
                            <div class="flex duration-1000 ease-in-out  justify-center" style="height: 450px"
                                data-carousel-item>
                                <div
                                    class="relative  max-w-4xl bg-white rounded-lg shadow-xl shadow-slate-800 dark:bg-gray-400  dark:border-gray-700 dark:bg-opacity-50" style="width:500px">
