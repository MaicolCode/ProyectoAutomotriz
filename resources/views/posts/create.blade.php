<x-app-layout>
    ...
    <x-slot name="title">
        Creación de Posts AMT
    </x-slot>
    <div class="mx-2 my-3">
        <div class=" h-32 flex items-center px-16 bg-rgba-blue-sky-200 bg-opacity-50">
            <h1 class="text-2xl text-white">Ingreso de datos para el blog...</h1>
        </div>
                    ...
                    <form method="POST" action="{{ route('posts.store') }}">
                        ...
                        <div class="flex mt-5">
                            ...
                            <div class="w-full mx-3">
                                ...
                                class="
                                     border-1 text-xs w-1/4 border-gray-300 dark:placeholder-gray-400" @endif
                                    placeholder="Inserta la descripcion de tu post aquí..." style="width: 600px" value="{{ old('description') }}"></textarea>
                                @error('description')
                                    <div class="flex gap-2 mt-2">
                                        <ion-icon name="alert-circle-outline" class="text-red-500"></ion-icon>
                                        <label class="text-xs text-red-500">{{ $message }}</label>
                        ...
                        <div class="flex justify-end m-8">
                            ...
                            <x-modals.modalQuestion message="¿Estas seguro de crear este blog?" />
                        </div>
                    </form>
                </div>
